...
#Instantiate the three Groups: walls, doors, and players.
...
player = Player((2*SIZE, 2*SIZE))
player.add(playgroup)
displaydoors = True
...
while True: # main game loop
    ...
    if pygame.sprite.spritecollideany(player, wallgroup) is not None:
        if Player_Up == True:
            Player_Up = False
            player.rect.y += 1
        if Player_Down == True:
